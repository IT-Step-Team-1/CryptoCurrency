...
contract ERC20Token is StandardToken {
    ...
    */
    string public name = 'Imovi';                   //fancy name: eg Simon Bucks
    ...
    string public symbol = 'IMOV';                 //An identifier: eg SBX
    string public version = 'V.1';       //human 0.1 standard. Just an arbitrary versioning scheme.
...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function ERC20Token(
        ...
        name = "ImoviToken";                                   // Set the name for display purposes
        decimals = 0;                            // Amount of decimals for display purposes
        symbol = "IMOV";                               // Set the symbol for display purposes
    }
